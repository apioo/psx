...
<div class="psx-resource psx-api-resource-generator-html-schema" data-path="/foo/bar" data-status="1">
	...
	<div class="psx-resource psx-resource-response" data-method="GET">
		...
		<div class="psx-resource-content">
			<div id="psx-type-9499a45cc2cb810ebcb38cc840bebf51" class="psx-complex-type">
				<h1>collection</h1>
						...
						<tr>
							...
							<td>
								<span class="psx-property-type psx-property-type-array">Array&lt;<span class="psx-property-type psx-property-type-complex">
										<a href="#psx-type-7738db4616810154ab42db61b65f74aa">item</a>
									</span>&gt;</span>
							</td>
							<td>
			...
			<div id="psx-type-7738db4616810154ab42db61b65f74aa" class="psx-complex-type">
				<h1>item</h1>
				<div class="psx-type-description"/>
				<table class="table psx-type-properties">
					<colgroup>
	...
	<div class="psx-resource psx-resource-request" data-method="POST">
		<h5>POST Request</h5>
		<div class="psx-resource-content">
			<div id="psx-type-5bd2953081685075d567417f01494700" class="psx-complex-type">
				<h1>item</h1>
				<div class="psx-type-description"/>
				<table class="table psx-type-properties">
					<colgroup>
	...
	<div class="psx-resource psx-resource-response" data-method="POST">
		...
		<div class="psx-resource-content">
			<div id="psx-type-a394c0a8d56c158f0f29acf97cbdc8f6" class="psx-complex-type">
				<h1>message</h1>
				<div class="psx-type-description"/>
				<table class="table psx-type-properties">
					<colgroup>
	...
	<div class="psx-resource psx-resource-request" data-method="PUT">
		<h5>PUT Request</h5>
		<div class="psx-resource-content">
			<div id="psx-type-cb65873d8f84681e263c50e2260d7bb9" class="psx-complex-type">
				<h1>item</h1>
				<div class="psx-type-description"/>
				<table class="table psx-type-properties">
					<colgroup>
