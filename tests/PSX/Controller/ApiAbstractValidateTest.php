...
{
    "success": false,
    "title": "PSX\\Data\\Schema\\ValidationException",
...
JSON;
    ...
    {
        return array(
            [['GET'], '/api', 'PSX\Controller\Foo\Application\TestApiValidateController::doIndex'],
            [['POST'], '/api', 'PSX\Controller\Foo\Application\TestApiValidateController::doInsert'],
        );
    }
}
