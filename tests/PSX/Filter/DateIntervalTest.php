<?php
/*
 *  $Id: DateIntervalTest.php 480 2012-05-01 18:13:54Z k42b3.x@googlemail.com $
 *
 * psx
 ...
 */
class PSX_Filter_DateIntervalTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$dateInterval = new PSX_Filter_DateInterval();
