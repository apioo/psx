...
<xsl:template match="*" mode="class.value">
  ...
  <!-- Use element name by default -->
  <xsl:choose>
    <xsl:when test="$class = 'programlisting'">
	  <xsl:value-of select="'programlisting prettyprint'" />
    </xsl:when>
    <xsl:when test="$class = 'code'">
	  <xsl:value-of select="'code prettyprint'" />
    </xsl:when>
    <xsl:when test="$class = 'informaltable'">
	  <xsl:value-of select="'informaltable table'" />
    </xsl:when>
    <xsl:when test="$class = 'classsynopsis'">
	  <xsl:value-of select="'classsynopsis prettyprint'" />
    </xsl:when>
	<xsl:otherwise>
