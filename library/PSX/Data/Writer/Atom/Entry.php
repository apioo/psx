...
class Entry
{
    ...
    public function addAuthor($name, $uri = false, $email = false)
    {
        ...
        Writer::personConstruct($this->writer, $name, $uri, $email);
    ...
    {
        Writer::categoryConstruct($this->writer, $term, $scheme, $label);
    }
    ...
    {
        Writer::linkConstruct($this->writer, $href, $rel, $type, $hreflang, $title, $length);
    }
    ...
    {
        Writer::textConstruct($this->writer, 'summary', $summary, $type);
    }

    public function setTitle($title, $type = null)
    {
        Writer::textConstruct($this->writer, 'title', $title, $type);
    }
