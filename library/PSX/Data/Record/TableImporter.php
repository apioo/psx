 ...
 * @link    http://phpsx.org
 */
class TableImporter implements ImporterInterface
{
	public function import($table, $data)
	{
		if(!$table instanceof TableInterface)
		{
			throw new InvalidArgumentException('Table must be an instanceof TableInterface');
		}
		...
		return new Record(lcfirst($table->getDisplayName()), $fields);
	}
