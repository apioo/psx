<?php
/*
 *  $Id: Post.php 624 2012-08-25 11:18:54Z k42b3.x@googlemail.com $
 *
 * psx
 ...
 * <code>
 * $post = new PSX_Input_Post();
 *
 * $id = $post->id('integer');
 * </code>
 *
 * If the $_POST variable id is available it contains an integer representation
 * else false
 *
