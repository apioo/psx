...
class BootstrapCacheCommand extends GenerateCommandAbstract
{
	...
	protected function getFiles()
	{
		return array(
			...
			PSX_PATH_LIBRARY . '/PSX/Controller/Tool/DefaultController.php',
			PSX_PATH_LIBRARY . '/PSX/Controller/ViewAbstract.php',
			...
			PSX_PATH_LIBRARY . '/PSX/Controller/Behaviour/AccessorTrait.php',
			PSX_PATH_LIBRARY . '/PSX/Controller/Behaviour/BodyTrait.php',
			PSX_PATH_LIBRARY . '/PSX/Controller/Behaviour/HttpTrait.php',
			PSX_PATH_LIBRARY . '/PSX/Controller/Behaviour/ImporterTrait.php',
			PSX_PATH_LIBRARY . '/PSX/Controller/Behaviour/RedirectTrait.php',
